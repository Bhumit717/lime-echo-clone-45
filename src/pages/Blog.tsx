...
const Blog = () => {
  ...
  const categories = [
    ...
    "Technology", "Agriculture", "Logistics", "Success Stories"
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
      ...
      <section className="pt-32 pb-20 relative z-10">
        <div className="container mx-auto px-4">
          ...
          {/* Newsletter CTA */}
          <div className="mt-20 bg-gradient-to-r from-ai-primary/20 to-ai-secondary/20 backdrop-blur-sm rounded-3xl p-12 text-center text-white border border-ai-primary/30 animate-glow">
            <div className="relative">
              <TrendingUp className="h-16 w-16 mx-auto mb-6 text-ai-primary animate-float" />
              <h2 className="text-3xl font-bold mb-4 animate-ai-text-glow">Stay Updated with Trade Insights</h2>
              <p className="text-xl mb-8 text-gray-300 max-w-2xl mx-auto animate-hologram">
                Get the latest export-import trends, market analysis, and business opportunities delivered to your inbox weekly.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-6 py-3 rounded-full bg-gray-800/50 border border-ai-primary/30 text-white placeholder-gray-400 focus:outline-none focus:border-ai-primary focus:ring-2 focus:ring-ai-primary/20"
                />
                <Button onClick={handleSubscribe} className="bg-gradient-to-r from-ai-primary to-ai-secondary hover:from-ai-secondary hover:to-ai-accent px-8 py-3 rounded-full font-medium animate-ai-pulse-glow">
